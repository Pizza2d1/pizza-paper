...
echo -e "\nThis lets you add or remove the pizza-paper.sh file to your \$PATH folder, specifically the /usr/custom_paths folder (which I use for my custom_commands as well)"
